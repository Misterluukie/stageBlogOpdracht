...
<div class="container">
    <div class="row justify-content-center">
        <div class="container max-w-60 mx-auto pt-4">
            <h2 class="font-bold text-3xl mb-2">Edit</h2>
            <form method="POST" action="/posts/{{$post->id}}">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="content" name="content"
                        class="h-20 bg-white border border-gray-300 rounded py-4 px-3 mr-4 w-full text-gray-600 text-sm focus:outline-none focus:border-gray-400 focus:ring-0">{{$post->content}}</textarea>
                </div>
